...
<TBODY>
<TR>
<td><SELECT name="keyfield" style="color:#333333; background-color:#f3f3f3;" class=input><OPTION value="subject"<?=$check[subject];?>>질문</OPTION><OPTION value="comment"<?=$check[comment];?>>내용</OPTION></SELECT></td>
