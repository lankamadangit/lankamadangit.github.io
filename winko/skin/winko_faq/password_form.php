...
<tr>
   <td colspan=2><table width=100% border=1 cellspacing=0 cellpadding=0 bgcolor=<?=$light?> bordercolorlight=<?=$dark?> bordercolordark=#FFFFFF>
  <tr>
...
<tr height=1><td colspan=2 bgcolor=<?=$dark?>><img src=images/t.gif height=1></td></tr>
...
<tr height=40>
  <td colspan=2 align=right>
     <input type=image align=absmiddle border=0 src="<?=$skin_folder?>/confirm.gif">&nbsp;<?=$a_list?><img src=<?=$skin_folder?>/list.gif border=0 align=absmiddle></a>&nbsp;<IMG align=absMiddle border=0 onclick=history.back() src="<?=$skin_folder?>/back.gif" style="CURSOR: hand">
  </td>
</tr>
</table>
<br><br>
