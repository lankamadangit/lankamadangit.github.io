...
<td align=center background="<?=$skin_folder?>/view_td.gif">
 ...
 <tr height="28">
  <td style=color:#333333 valign="bottom">이름</td>
  <td style=color:#333333 valign="bottom">내용</td>
<?=$hide_short_password_start?>
  <td style=color:#333333 valign="bottom">비밀번호</td>
...
<?=$hide_short_password_end?>
  <td width=50 align='center' valign=top><input type=submit class=submit class=height:18px value=' 쓰 기 '></td>
  </tr>
