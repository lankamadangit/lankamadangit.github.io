<table width="<?=$table_width?>" border="0" cellspacing="0" cellpadding="0" align="center">
	...
	<?=$hide_file1_start?>
	<tr height="28">
		<td align="right" bgcolor=<?=$light?>><img src="<?=$skin_folder?>/main.gif" align="absmiddle" />&nbsp;이미지1&nbsp;&nbsp;</td>
	...
	<tr height="28">
		<td align="right" bgcolor=<?=$light?>><img src="<?=$skin_folder?>/main.gif" align="absmiddle" />&nbsp;이미지1&nbsp;&nbsp;</td>
		<td>&nbsp;&nbsp;<input type="file" name="userfile" size="20" style="height:20px;" /> (최대 2M)</td>
	</tr>
	<?=$hide_ok_file1_end?>
	<?=$hide_file2_start?>
	<tr height="28">
		<td align="right" bgcolor=<?=$light?>><img src="<?=$skin_folder?>/main.gif" align="absmiddle" />&nbsp;이미지2&nbsp;&nbsp;</td>
		<td>&nbsp;&nbsp;<?=$my_userfile2?>&nbsp;<span style="font-size:8pt;"><font face="Tahoma">(<b><?=$my_filesize2?></b>byte)</font></span>&nbsp;&nbsp;삭제 : <input type="checkbox" name="filecheck2" /></td>
	</tr>
	<?=$hide_file2_end?>
	<?=$hide_ok_file2_start?>
	<tr height="28">
		<td align="right" bgcolor=<?=$light?>><img src="<?=$skin_folder?>/main.gif" align="absmiddle" />&nbsp;이미지2&nbsp;&nbsp;</td>
		<td>&nbsp;&nbsp;<input type="file" name="userfile2" size="20" style="height:20px;" /> (최대 2M)</td>
	</tr>
	<?=$hide_ok_file2_end?>
	<tr>
