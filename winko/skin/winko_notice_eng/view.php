<table border="0" cellspacing="0" cellpadding="0" width="<?=$table_width?>" bgcolor="<?=$bbs_color2?>" align='center'>
	...
	<tr height="26">
		<td align="right" width="100" style="color:#333333"><img src="<?=$skin_folder?>/main.gif" align='absmiddle' alt="">&nbsp;Subject&nbsp;&nbsp;|</td>
	...
	<tr height="26">
		<td align="right" width="100" style="color:#333333"><img src="<?=$skin_folder?>/main.gif" align='absmiddle' alt="">&nbsp;Date&nbsp;&nbsp;|</td>
		<td style="color:#333333">&nbsp;&nbsp;<font class="thm8"><?=$my_signdate?></font></td>
	</tr>
	<?=$hide_file1_start?>
	<tr height="26">
		<td align="right" width="100" style="color:#333333"><img src='<?=$skin_folder?>/main.gif' align='absmiddle'>&nbsp;Download&nbsp;&nbsp;|</td>
