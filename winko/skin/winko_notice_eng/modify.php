<table width="<?=$table_width?>" border="0" cellspacing="0" cellpadding="0" align="center">
	...
	<tr height="28">
		...
		<td><?=$hide_notice_start?>&nbsp;&nbsp;<INPUT type="checkbox" value="1" name="notice" <?=$check[$my_notice]?> />(Notice)<?=$hide_notice_end?><?=$hide_secret_start?>&nbsp;&nbsp;<INPUT type="checkbox" value="1" name="ok_secret" <?=$check[$my_ok_secret]?> />(비밀글)<?=$hide_secret_end?></td>
	</tr>
	<tr height="28">
