<table width="<?=$table_width?>" border="0" cellspacing="0" cellpadding="0" align="center">
	...
	<tr height="28">
		...
		<td><?=$hide_html_start?>&nbsp;<input type="checkbox" name="ok_html" value="1" />(HTML)<?=$hide_html_end?><?=$hide_notice_start?>&nbsp;&nbsp;<INPUT type="checkbox" value="1" name="notice" />(공지글 등록)<?=$hide_notice_end?><?=$hide_secret_start?><?if($member[no]){?>&nbsp;&nbsp;<INPUT type="checkbox" value="1" name="ok_secret" />(비밀글)<?}?><?=$hide_secret_end?></td>
	</tr>
	<tr height="28">
