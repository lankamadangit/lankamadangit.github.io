		...
		<td>
			<table cellpadding="0" cellspacing="0" width="100%" height="27">
				<tr>
					...
					?>&nbsp;&nbsp;<img src="<?=$head_icon?>" border="0" align="absMiddle" />&nbsp;<a href="winko.php?code=<?=$code?>&body=view&page=<?=$page?>&number=<?=$my_uid?>&category=<?=$category?>&keyfield=<?=$keyfield?>&key=<?=$encoded_key?>"><?=$my_subject?></a><?=$file_icon?><?=$total_short?><?=$new_icon?></a></td>
	...
	<tr>
		<td background="<?=$skin_folder?>/dot_w.gif"><img src="image/etc/blank.gif" width="1" height="1" border="0" /></td>
	</tr>
