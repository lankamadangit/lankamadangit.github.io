...
<div align="center">
	...
	<table border="0" width="300" cellpadding="0" cellspacing="0">
		...
		<tr height="40">
			<td colspan="2" align="right"><input type="image" align="absmiddle" border="0" src="<?=$skin_folder?>/confirm.gif" hspace="3"><?=$a_list?><img src="<?=$skin_folder?>/list.gif" border="0" align="absmiddle" style="padding:0px 5px 0px 5px;"></a><img align="absMiddle" border="0" onclick="history.back()" src="<?=$skin_folder?>/back.gif" style="CURSOR: hand" hspace="3" /></td>
		</tr>
	</table>
</div>
<br /><br />
